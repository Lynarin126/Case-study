...
@section('title', 'កែប្រែអ្នកប្រើប្រាស់ | LMS')
...
<section class="content-header px-0">
    <div class="container-fluid px-0">
        <div class="row mb-2 align-items-center page-header-premium">
            <div class="col-sm-7">
                <h1 class="mb-1"><i class="fas fa-user-edit"></i> កែប្រែអ្នកប្រើប្រាស់</h1>
            </div>
            <div class="col-sm-5">
...
<div class="card form-card-premium">
    <div class="card-header-premium">
        ...
        <p>កែប្រែព័ត៌មានគណនីខាងក្រោម រួចរក្សាទុកការផ្លាស់ប្តូរ</p>
    </div>
