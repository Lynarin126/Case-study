...
@section('title', 'បង្កើតឆ្នាំសិក្សា | LMS')
...
<section class="content-header px-0">
    <div class="container-fluid px-0">
        <div class="row mb-2 align-items-center page-header-premium">
            <div class="col-sm-7">
                <h1 class="mb-1"><i class="fas fa-calendar-plus"></i> បង្កើតឆ្នាំសិក្សា</h1>
            </div>
            <div class="col-sm-5">
...
<div class="card form-card-premium">
    <div class="card-header-premium">
        <h2>ព័ត៌មានឆ្នាំសិក្សា</h2>
        <p>បំពេញព័ត៌មានខាងក្រោមដើម្បីបង្កើតឆ្នាំសិក្សាថ្មី</p>
    </div>
