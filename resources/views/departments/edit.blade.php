...
@section('title', 'កែប្រែដេប៉ាតឺម៉ង់ | LMS')
...
<section class="content-header px-0">
    <div class="container-fluid px-0">
        <div class="row mb-2 align-items-center page-header-premium">
            <div class="col-sm-7">
                <h1 class="mb-1"><i class="fas fa-building"></i> កែប្រែដេប៉ាតឺម៉ង់</h1>
                <p class="text-muted mb-0">កែប្រែព័ត៌មានដេប៉ាតឺម៉ង់ដែលបានជ្រើសរើស។</p>
            </div>
            <div class="col-sm-5">
